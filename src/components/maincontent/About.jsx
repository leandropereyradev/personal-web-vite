  ...
  return (
    <div id="about" className="pt-10 xl:pt-14 fullHD:pt-12">
      ...
      <div className="flex flex-col gap-6">
        <p>
          Nací en Buenos Aires, Argentina, pero llevo años en España. Adaptarme
          no fue fácil, pero la resiliencia me enseñó a construir algo valioso
        ...
        <p>
          ...
          calidad. También estoy desarrollando una app personal para estudiar.
          Uso React y Local Storage, por el momento, sin embargo planeo integrar
        ...
        <p>
          ...
          . Aunque los <span className="italic font-bold">INSERT</span> de
          antojos a veces ganan a los{" "}
          <span className="italic font-bold">DELETE</span>, ¡intento no
          sobrecargar el sistema, jaja!
        </p>
        <p>
          También me encanta crear y arreglar cosas: pintar cuadros, cuidar mi
          balcón o cositas en casa. Ni hablar de las cenas en casa con amigos!
          que manera de reírnos! Estas actividades me llenan de energía y me
          hacen volver al teclado con más ganas.
        </p>
        <p>
          Si compartes mi pasión por crear cosas que marquen la diferencia,
          estaré encantado de colaborar contigo. ¡Hablemos y hagamos algo
          increíble juntos!
        </p>
      </div>
    </div>
